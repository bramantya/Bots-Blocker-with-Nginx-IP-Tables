...
yum -y install wget
cd /etc/nginx/bots.d 
wget https://raw.githubusercontent.com/bramantya/Bots-Blocker-with-Nginx-IP-Tables/master/blacklist.conf.txt -O blacklist.conf
wget https://raw.githubusercontent.com/bramantya/Bots-Blocker-with-Nginx-IP-Tables/master/blockips.conf.txt -O blockips.conf
...
cd ~
wget https://raw.githubusercontent.com/bramantya/Bots-Blocker-with-Nginx-IP-Tables/master/block.txt -O block 
wget https://raw.githubusercontent.com/bramantya/Bots-Blocker-with-Nginx-IP-Tables/master/ips.txt -O ips 
chmod +x block 
./block
